...
import UserStatsComponent, { UserStats } from '@/apps/web/components/profile/UserStatsComponent';
import AttemptsHistory, { AttemptWithSentence } from '@/apps/web/components/profile/AttemptsHistory';
import ActivityHeatmap from '@/apps/web/components/profile/ActivityHeatmap';
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 p-8">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          ...
          {stats ? <UserStatsComponent stats={stats} /> : null}
        </div>
                ...
                >
                  ...
                  {sentenceOptions.map((item) => (
                    <option key={item.sentenceId} value={item.sentenceId}>
                      {item.sentenceText.length > 60
                        ? `${item.sentenceText.slice(0, 60)}...`
                        : item.sentenceText}
                    </option>
                  ))}
                </select>
