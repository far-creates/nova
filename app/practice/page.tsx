...
import TrackListSidebar from '@/app/components/modules/TrackListSidebar';
  ...
  return (
    <div className="min-h-screen px-4 py-8 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-7xl space-y-8">
        <Card variant="feature" padding="md" className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
        ...
        <PracticeWorkspace
          ...
          feedbackTone={submitMessage.toLowerCase().includes('could not') ? 'error' : submitMessage ? 'success' : 'neutral'}
